...
\begin{lstlisting}[language=Python, caption={StackExchange Dataset Loading}, captionpos=b]
#coding=utf-8
...
\begin{lstlisting}[language=Python, caption={Expert Finding}, captionpos=b]
# encoding=utf8
import sys
reload(sys)
